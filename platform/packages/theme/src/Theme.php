...
class Theme implements ThemeContract
{
    ...
    {
        // Check if we're on a product page - if so, don't generate basic breadcrumb schema
        // as the ecommerce plugin will generate enhanced product schema with breadcrumbs
        ...
        if (! empty($this->breadcrumb->crumbs) && !$isProductPage) {
            $schema = [
