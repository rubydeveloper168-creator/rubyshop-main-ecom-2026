  ...
  <section class="py-12 px-4 max-w-screen-xl mx-auto">
    <h3 class="text-2xl font-bold mb-8 text-center">อุปกรณ์เพื่อการช่าง</h3>

<!-- Slider Container -->
<div class="relative overflow-hidden max-w-full mx-auto rounded-lg shadow-lg">
  <div id="slider-container" class="flex transition-transform duration-300 slider gap-4">
  ...
  <!-- Navigation Buttons -->
  <button id="prev-btn" class="absolute left-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white w-12 h-12 rounded-full flex items-center justify-center z-10 hover:bg-opacity-70 transition-all duration-300">
    &#9664;
  </button>
  <button id="next-btn" class="absolute right-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white w-12 h-12 rounded-full flex items-center justify-center z-10 hover:bg-opacity-70 transition-all duration-300">
    &#9654;
  </button>
</div>
</section>
  ...
  <!-- Statement Bar -->
<section class="bg-red-500 text-white py-6 text-center h-[150px] flex flex-col justify-center">
    <h4 class="text-3xl font-bold uppercase mb-2 ">Guaranteed Tough®</h4>
    <p class="text-base uppercase ">เพื่อช่างมืออาชีพ งานจบไว มั่นใจคุณภาพ</p>
</section>
...
<section class="relative w-full py-8 sm:py-12">
  <div class="grid grid-cols-1 md:grid-cols-2 w-full">
    ...
    <div class="relative h-[450px] sm:h-[500px] md:h-[600px] overflow-hidden group">
      ...
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-4 sm:p-6 lg:p-8 transition-all duration-300 group-hover:from-black/90 group-hover:via-black/50">
        <div class="max-w-xl mx-auto md:mr-0 md:ml-auto">
          <h2 class="text-2xl sm:text-3xl font-bold text-white text-center transform transition-transform duration-300 group-hover:translate-y-[-8px]">POWERFUL</h2>
          <p class="text-sm sm:text-base lg:text-lg mt-2 sm:mt-4 text-white text-center opacity-90 transition-opacity duration-300 group-hover:opacity-100">
            พลังแรงเต็มพิกัด รองรับงานหนักทุกรูปแบบ ให้คุณทำงานได้อย่างเต็มประสิทธิภาพ ไม่ว่าจะเจองานยากแค่ไหนก็เอาอยู่
          </p>
          <div class="text-center mt-3 sm:mt-4 transform transition-all duration-300 group-hover:translate-y-[-4px]">
            <a href="https://www.rubyshop.co.th/product-categories/concrete-chaser" class="inline-block bg-red-600 text-white font-semibold py-2 px-4 sm:px-6 rounded-full hover:bg-red-500 hover:shadow-lg hover:scale-105 transition-all duration-300">
              LEARN MORE
            </a>
          </div>
        </div>
    ...
    <!-- Right Section - Full width to right edge -->
    <div class="relative h-[450px] sm:h-[500px] md:h-[600px] overflow-hidden group">
      <img 
      ...
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-4 sm:p-6 lg:p-8 transition-all duration-300 group-hover:from-black/90 group-hover:via-black/50">
        <div class="max-w-xl mx-auto md:ml-0 md:mr-auto">
          <h2 class="text-2xl sm:text-3xl font-bold text-white text-center transform transition-transform duration-300 group-hover:translate-y-[-8px]">PERFORMANCE</h2>
          <p class="text-sm sm:text-base lg:text-lg mt-2 sm:mt-4 text-white text-center opacity-90 transition-opacity duration-300 group-hover:opacity-100">
